...
<div class="container">
    ...
    <p class="text-base pb-5 max-w-lg">Inget bener bener ya gw ga bikin fitur lupa password catet dihp, WA, IG, Buku, apadah teserah lu</p>
    ...
    <form action="{{ route('ganti-password') }}" method="post"  class="max-w-lg">
        @method('put')
        @csrf
        <div class="mb-6">
